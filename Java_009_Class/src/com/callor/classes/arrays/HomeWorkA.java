...
public class HomeWorkA {
	public static void main(String[] args) {
		...
		for(int index = 0; index < scores.length; index++) {
			scores[index].stKor = scService.getScore();
			scores[index].stEng = scService.getScore();
			scores[index].stMath = scService.getScore();
		}
