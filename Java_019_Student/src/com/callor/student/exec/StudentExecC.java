 ...
 * 하지만, StudentService interface 에는 insertStudent() method가 없다
 * 
 * 1. Service interface 에 insertStudnet() method 를 추가해 주기를
 * 	팀장에게 요청하기
 ...
 *  예정이라면 이 방법이 최선이다
 *  하지만, 어떤 특정 개발자의 필요에 의해서 insertStudent() method가
 *  작성되었다면, 절대 해서는 안될 일이다.
 *  
 * 2. 객체의 형변환을 통하여 생성된 객체를 자신의 ImpvV1 클래스로 
...
public class StudentExecC {
	...
	public static void main(String[] args) {
		...
		/*
		 * stService 는 StudentSerivce(interface) type 의 객체이다
