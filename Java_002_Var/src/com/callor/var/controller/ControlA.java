...
public class ControlA {
	...
	public static void main(String[] args) {
		...
		// bEven1의 변수의 값이 true 이면?
		if(bEven1) {
			System.out.println(num1 + "는(은) 짝수야!!!");			
		}
		// bEven2의 변수의 값이 true 이면?
		if(bEven2) {
			System.out.println(num2 + "는(은) 짝수야!!!");
		}
		
		// bEven2 값이 true가 아니면?
		if(!bEven2) {
			System.out.println(num2 + "는(은) 짝수가 아니야!!!");
		}
		/*
		 * Control keyWord
		 * 어떤 조건에 따라 코드 실행 순서를 변경하는 명령문
		 * if() 명령문 () 의 조건이 true, false 냐에 따라
		 * 코드의 실행순서를 약간 변경한다
		 * 
		 *
		 * if() 명령문에서 
